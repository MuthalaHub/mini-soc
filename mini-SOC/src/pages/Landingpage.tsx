        ...
        <div className="relative mx-auto grid max-w-7xl items-center gap-12 px-5 py-20 sm:px-8 lg:grid-cols-[1.05fr_0.95fr] lg:py-28">
          ...
          <div>
            ...
            <h1 className="mt-5 text-4xl font-bold leading-[1.05] tracking-tight text-white sm:text-5xl lg:text-6xl">
              See the outlier.
              <br />
              <span className="text-[#FFD400]">Trace the ring.</span>
            </h1>
          ...
          {/* signature: live alert feed */}
          <div className="relative">
            <div className="overflow-hidden rounded-xl border border-[#262626] bg-[#141414] shadow-2xl shadow-black/40">
              <div className="flex items-center justify-between border-b border-[#262626] bg-[#1A1A1A] px-4 py-3">
                <div className="flex items-center gap-2">
                  <span className="h-2 w-2 animate-pulse rounded-full bg-[#46C26B] motion-reduce:animate-none" />
                  <span className="font-mono text-xs tracking-widest text-[#A3A3A3]">
                    ALERT FEED · LIVE
                  </span>
                </div>
                <span className="font-mono text-xs text-[#8A8A8A]">composite score ↓</span>
              </div>
              <AlertRow acc="ACC-4471" kind="Mule-chain pattern · CASH-OUT" score="0.94" band="HIGH" />
              <AlertRow acc="ACC-1180" kind="Velocity spike · TRANSFER" score="0.61" band="MEDIUM" />
              <AlertRow acc="ACC-9032" kind="Off-hours cash-out" score="0.22" band="LOW" />
              <div className="flex items-center justify-between bg-[#1A1A1A] px-4 py-2.5">
                <span className="font-mono text-[10px] tracking-widest text-[#8A8A8A]">
                  s_comp = α·s_IF + (1−α)·s_GR
                </span>
                <span className="font-mono text-[10px] text-[#FFD400]">AUPRC-tuned</span>
              </div>
            </div>
          </div>
        </div>
